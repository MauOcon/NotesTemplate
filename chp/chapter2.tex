...
Para mostrar árboles de directorios se utiliza el paquete \emph{dirtree}. A continuación se muestra un ejemplo para mostrar un árbol de directorios.
...
También se puede incluir una etiqueta al utilizarlo dentro de un entorno \emph{figure}, por ejemplo (figure \ref{fig:programming_tools-dirtree}).

\begin{figure}[htbp] % Use 'figure' environment for floating
	%\centering % Center the dirtree
	\dirtree{%
		.1 Root Directory.
		.2 Subdirectory 1.
		.3 File A.txt.
	...
	\caption{Example of a directory tree structure.} % Add your caption here
	\label{fig:programming_tools-dirtree} % Optional: Add a label for referencing
\end{figure}
