...
%\usepackage[colorlinks=true,plainpages=true,citecolor=blue,linkcolor=blue]{hyperref} % can't load it because pdfcomment loads it
\hypersetup{
	colorlinks=true,
	plainpages=true,	
	linkcolor=blue
